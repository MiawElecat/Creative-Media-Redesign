                    ...
                    <form method="POST" action="{{ route('admin.artikel.store') }}" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <x-text-input id="judul" class="block mt-1 w-full" type="text" name="judul"
                                :value="old('judul')" required autofocus autocomplete="off" />
                        ...
                        <div>
                            ...
                            <textarea id="excerpt" name="excerpt" rows="3"
                                class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('excerpt') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="konten_lengkap" name="konten_lengkap" rows="15" required
                                class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('konten_lengkap') }}</textarea>
                        ...
                        <div class="block">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Jika dicentang, artikel akan
                                langsung tampil di halaman publik.</p>
