        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.karya-siswa.store') }}" enctype="multipart/form-data"
                        class="space-y-6">
                        @csrf

                        <div>
                            <x-input-label for="gambar" :value="__('Gambar Karya')" />
                            <input id="gambar"
                                ...
                                type="file" name="gambar" accept="image/*" required>
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_siswa" class="block mt-1 w-full" type="text" name="nama_siswa"
                                :value="old('nama_siswa')" autocomplete="off" />
                        ...
                        <div>
                            ...
                            <x-text-input id="kursus" class="block mt-1 w-full" type="text" name="kursus"
                                :value="old('kursus')" autocomplete="off" />
